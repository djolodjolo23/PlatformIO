...
const char* ssid = "Tele2_108703"; //Enter SSID
const char* password = "q2yymgzk"; //Enter Password

const char* websockets_server_host = "ws://localhost:8081"; //Enter server address
