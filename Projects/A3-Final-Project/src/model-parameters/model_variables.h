...
#include "tflite-model/tflite_learn_311_compiled.h"
#include "edge-impulse-sdk/classifier/ei_model_types.h"
#include "edge-impulse-sdk/classifier/inferencing_engines/engines.h"

const char* ei_classifier_inferencing_categories[] = { "circle", "square", "triangle", "unknown" };

uint8_t ei_dsp_config_310_axes[] = { 0, 1, 2, 3, 4, 5 };
const uint32_t ei_dsp_config_310_axes_size = 6;
ei_dsp_config_spectral_analysis_t ei_dsp_config_310 = {
    310, // uint32_t blockId
...
ei_model_dsp_t ei_dsp_blocks[ei_dsp_blocks_size] = {
    { // DSP block 310
        ...
        (void*)&ei_dsp_config_310, // pointer to config struct
        ei_dsp_config_310_axes, // array of offsets into the input stream, one for each axis
        ei_dsp_config_310_axes_size, // number of axes
        1, // version
        nullptr, // factory function
    }
};
const ei_config_tflite_eon_graph_t ei_config_tflite_graph_311 = {
    .implementation_version = 1,
    .model_init = &tflite_learn_311_init,
    .model_invoke = &tflite_learn_311_invoke,
    .model_reset = &tflite_learn_311_reset,
    .model_input = &tflite_learn_311_input,
    .model_output = &tflite_learn_311_output,
};

const ei_learning_block_config_tflite_graph_t ei_learning_block_config_311 = {
    .implementation_version = 1,
    ...
    .quantized = 1,
    .compiled = 1,
    .graph_config = (void*)&ei_config_tflite_graph_311
};

const uint8_t ei_learning_blocks_size = 1;
const uint32_t ei_learning_block_311_inputs[1] = { 310 };
const uint8_t ei_learning_block_311_inputs_size = 1;
const ei_learning_block_t ei_learning_blocks[ei_learning_blocks_size] = {
    {
        311,
        false,
        &run_nn_inference,
        (void*)&ei_learning_block_config_311,
        EI_CLASSIFIER_IMAGE_SCALING_NONE,
        ei_learning_block_311_inputs,
        ei_learning_block_311_inputs_size,
        4
    },
};
