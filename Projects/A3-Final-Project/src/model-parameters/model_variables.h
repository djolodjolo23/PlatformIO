...
#include "tflite-model/tflite_learn_914_compiled.h"
#include "edge-impulse-sdk/classifier/ei_model_types.h"
#include "edge-impulse-sdk/classifier/inferencing_engines/engines.h"

const char* ei_classifier_inferencing_categories[] = { "circle", "square", "triangle", "unknown" };

uint8_t ei_dsp_config_913_axes[] = { 0, 1, 2, 3, 4, 5 };
const uint32_t ei_dsp_config_913_axes_size = 6;
ei_dsp_config_spectral_analysis_t ei_dsp_config_913 = {
    913, // uint32_t blockId
...
ei_model_dsp_t ei_dsp_blocks[ei_dsp_blocks_size] = {
    { // DSP block 913
        ...
        (void*)&ei_dsp_config_913, // pointer to config struct
        ei_dsp_config_913_axes, // array of offsets into the input stream, one for each axis
        ei_dsp_config_913_axes_size, // number of axes
        1, // version
        nullptr, // factory function
    }
};
const ei_config_tflite_eon_graph_t ei_config_tflite_graph_914 = {
    .implementation_version = 1,
    .model_init = &tflite_learn_914_init,
    .model_invoke = &tflite_learn_914_invoke,
    .model_reset = &tflite_learn_914_reset,
    .model_input = &tflite_learn_914_input,
    .model_output = &tflite_learn_914_output,
};

const ei_learning_block_config_tflite_graph_t ei_learning_block_config_914 = {
    .implementation_version = 1,
    ...
    .quantized = 0,
    .compiled = 1,
    .graph_config = (void*)&ei_config_tflite_graph_914
};

const uint8_t ei_learning_blocks_size = 1;
const uint32_t ei_learning_block_914_inputs[1] = { 913 };
const uint8_t ei_learning_block_914_inputs_size = 1;
const ei_learning_block_t ei_learning_blocks[ei_learning_blocks_size] = {
    {
        914,
        false,
        &run_nn_inference,
        (void*)&ei_learning_block_config_914,
        EI_CLASSIFIER_IMAGE_SCALING_NONE,
        ei_learning_block_914_inputs,
        ei_learning_block_914_inputs_size,
        4
    },
};
