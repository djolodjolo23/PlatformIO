...
const ei_impulse_t impulse_531882_0 = {
    .project_id = 531882,
    .project_owner = "Djordje Dimitrov",
    .project_name = "a2-iot-djordje",
    .impulse_id = 1,
...
ei_impulse_handle_t impulse_handle_531882_0 = ei_impulse_handle_t( &impulse_531882_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_531882_0;
